...
namespace MorpionApp
{
    ...
    public class UnitTest_PuissanceQuatre
    {
        [Fact]
        [Trait("PuissanceQuatre", "VerifVictoire")]
        public void Test_victoire_toute_lignes()
        {
            ...
            for (int ligne = 0; ligne < 4; ligne++)
            {
                ...
                for (int col = 0; col < 4; col++)
                {
                    ...
                    joueur = (ligne + col) % 2 == 0 ? 'X' : 'O'; // Alterner entre X et O
                    for (int j = 0; j < 4; j++)
                    {
                        puissanceQuatre.grille[ligne, j] = joueur;
                    }
                    Assert.True(puissanceQuatre.verifVictoire(joueur));
                }
            }
        }

        [Fact]
        public void Test_victoire_toute_colonnes()
        {
            PuissanceQuatre puissanceQuatre;
            char joueur;
            ...
            for (int col = 0; col < 4; col++)
            {
                ...
                for (int ligne = 0; ligne < 4; ligne++)
                {
                    ...
                    for (int i = 0; i < 4; i++)
                    {
                        puissanceQuatre.grille[i, col] = joueur;
                    }
                    Assert.True(puissanceQuatre.verifVictoire(joueur));
                }
            }
        ...
        public void Test_victoire_diagonale_descendante()
        {
            ...
            // Parcourir la diagonale descendante pour le joueur X
            for (int i = 0; i < 4; i++)
            {
            ...
            joueur = 'O'; // Changer de joueur à O

            // Parcourir la diagonale descendante pour le joueur O
            for (int i = 0; i < 4; i++)
            {
                puissanceQuatre.grille[i, i] = joueur;
            }
        ...
        public void Test_victoire_diagonale_ascendante()
        {
            ...
            // Parcourir la diagonale ascendante pour le joueur X
            for (int i = 0; i < 4; i++)
            {
                puissanceQuatre.grille[i, 3 - i] = joueur;
            }
            Assert.True(puissanceQuatre.verifVictoire(joueur));

            joueur = 'O'; // Changer de joueur à O

            // Parcourir la diagonale ascendante pour le joueur O
            for (int i = 0; i < 4; i++)
            {
                puissanceQuatre.grille[i, 3 - i] = joueur;
            }
        ...
        public void Test_pas_de_victoire()
        {
            ...
            Assert.False(puissanceQuatre.verifVictoire('O'));
        }
        ...
        {
            PuissanceQuatre puissanceQuatre = new PuissanceQuatre();
            Assert.False(puissanceQuatre.verifEgalite());
        }
    }
